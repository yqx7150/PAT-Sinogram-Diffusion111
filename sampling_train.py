...
def shared_predictor_update_fn(
    ...
    score_fn = mutils.get_score_fn(
        sde, model, good=good, train=False, continuous=continuous
    )
...
def shared_corrector_update_fn(
    x, t, sde, model, corrector, continuous, snr, n_steps, good
):
    ...
    def pc_sampler(model, good):
        ...
        with torch.no_grad():
            ...
            for i in range(sde.N):
                ...
                x, x_mean = predictor_update_fn(x, vec_t, good, model=model)
                x, x_mean = corrector_update_fn(x, vec_t, good, model=model)
